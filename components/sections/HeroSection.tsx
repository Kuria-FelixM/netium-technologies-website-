...
export function HeroSection() {
  ...
  return (
    <section id="hero" className="relative min-h-screen bg-gradient-to-b from-secondary via-blue-900 to-secondary text-white pt-32 pb-20 overflow-hidden">
      ...
      <Container className="relative z-10 py-0">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-lg sm:text-xl text-white text-opacity-90 mb-10 leading-relaxed text-balance">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button
                ...
                className="bg-primary hover:bg-blue-700 text-white px-8 py-6 text-lg font-bold flex items-center gap-2 w-full sm:w-auto justify-center sm:justify-start rounded-lg"
              >
                Get Free Assessment
              ...
              <Button
                ...
                className="border-2 border-white bg-transparent text-white hover:bg-white hover:text-secondary px-8 py-6 text-lg font-bold w-full sm:w-auto justify-center sm:justify-start transition-all rounded-lg"
              >
                Explore Services
              </Button>
            </div>
